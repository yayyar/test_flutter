import 'package:fl_firebase_test/src/application_state.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          const IconAndDetail(Icons.calendar_today, 'Jun 25'),
          const IconAndDetail(Icons.location_city, 'Yangon'),
